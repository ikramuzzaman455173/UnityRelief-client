...
// import ReliefGoodsData from "../../../public/Data/ReliefGoodsData";
...
//   const reliefGoodData = ReliefGoodsData.find((item) => item.id === dataId) as
//     | ReliefGood
//     | undefined;
//   console.log(reliefGoodData);

//   return (
//     <div className="my-10">
//       <PageBanner heading="Details page" bgImg={BannerImg} />
//       <section className="text-gray-700 body-font overflow-hidden bg-custom-light dark:bg-custom-dark mt-24 rounded-md border dark:border-custom-gray-300">
//         <div className="container px-5 py-24 mx-auto">
//           <div className="lg:w-4/5 mx-auto flex flex-wrap">
//             <img
//               alt="named"
//               className="lg:w-1/2 w-full object-cover object-center rounded border p-1 shadow-md dark:bg-custom-gray-300"
